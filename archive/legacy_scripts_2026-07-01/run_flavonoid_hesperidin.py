#!/usr/bin/env python3
"""
使用flavonoid配置（USPTO + 黄酮类模板）对橙皮苷进行逆合成分析
"""
import json
import sys
import time
...
CONFIG_FILE = "/home/ljx/retro_synthesis/config/flavonoid.yml"
...
def run_retrosynthesis():
    """运行逆合成分析"""
    print("=" * 60)
    print("橙皮苷逆合成分析 - Flavonoid配置（USPTO + 黄酮类模板）")
    print("=" * 60)
    ...
    output_file = OUTPUT_DIR / f"{timestamp}-hesperidin_flavonoid_combined.json"
