#!/usr/bin/env python3
"""
使用baseline配置（仅USPTO模板）对橙皮苷进行逆合成分析
"""
import json
import sys
import time
...
CONFIG_FILE = "/home/ljx/retro_synthesis/config/baseline.yml"
...
def run_retrosynthesis():
    """运行逆合成分析"""
    print("=" * 60)
    print("橙皮苷逆合成分析 - Baseline配置（仅USPTO模板）")
    print("=" * 60)
    ...
    output_file = OUTPUT_DIR / f"{timestamp}-hesperidin_baseline_uspto.json"
